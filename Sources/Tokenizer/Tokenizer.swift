@freestanding(codeItem) macro go(emit: Character) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., emit: Token..., reconsume: Character, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., emit: Token..., clearTemp: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., emit: Token..., emitTempAndReconsume: Character, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., emit: Token..., emitTempAndEmit: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createTemp: Character, emit: Token..., to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., appendTemp: Character, emit: Character) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createComment: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., appendComment: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., createStartTag: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createEndTag: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createEndTag: Character, appendTemp: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., appendTagName: Character, appendTemp: Character) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createAttr: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., emitSelfClosingTag: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError..., createDOCTYPE: Character, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError..., emitDOCTYPE: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")

...
@freestanding(codeItem) macro go(emit: Char, _: Char) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: Char, _: Char, _: Char, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: Char, _: Char, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(emit: Char, _: Char, emitTempAndEmit: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(emit: Char, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(emit: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, _: consuming Token, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, _: consuming Token, _: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, _: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, _: consuming Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(emit: consuming Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(appendAttrValue: Char, _: Char) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError, emit: Char, _: Char, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError, emit: Char, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, _: consuming Token, _: consuming Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, _: consuming Token, _: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, _: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, _: consuming Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, emit: consuming Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")

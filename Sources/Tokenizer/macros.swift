...
@freestanding(codeItem)
macro go(emit: Char, _: Char, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
...
@freestanding(codeItem)
macro go(emit: Char, _: Char, emitTempAndEmit: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Char, _: Char, emitTempAndReconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Char, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
...
@freestanding(codeItem)
macro go(emit: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, _: Token, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, _: Token, _: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, _: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, _: Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(emit: Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
...
@freestanding(codeItem)
macro go(error: ParseError, emit: Char, _: Char, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Char, _: Char, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Char, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
...
@freestanding(codeItem)
macro go(error: ParseError, emit: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, _: Token, _: Token) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, _: Token, _: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, _: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, _: Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
macro go(error: ParseError, emit: Token, reconsume: Char, in: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem)
